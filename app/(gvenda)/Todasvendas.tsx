...
import { View, FlatList, StyleSheet, TouchableOpacity, Alert, ImageBackground, ActivityIndicator, RefreshControl, Platform, SafeAreaView, StatusBar, TextInput } from 'react-native';
...
const styles = StyleSheet.create({
    ...
    resumoItem: { fontSize: 16, fontFamily: 'Roboto-Regular', color: '#E0E0FF', marginBottom: 8, lineHeight: 22 },
    resumoItemPendente: { fontSize: 16, color: '#FFCC80', fontFamily: 'Roboto-Bold', marginBottom: 8, lineHeight: 22 },
    subTitle: { fontSize: 22, fontFamily: 'Roboto-Bold', marginBottom: 15, color: '#FFFFFF', textAlign: 'center' },
    progressoHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, },
    progressoLabel: { fontSize: 14, fontFamily: 'Roboto-Bold', color: '#E0E0FF', },
    progressoTexto: { fontSize: 14, fontFamily: 'Roboto-Bold', color: '#FFFFFF', },
    ...
    filtroTexto: { color: '#FFFFFF', fontFamily: 'Roboto-Bold', fontSize: 13, },
    ...
    clienteNomeCard: { fontSize: 17, fontFamily: 'Roboto-Bold', color: '#FFFFFF', flex: 1 },
    ...
    itemQuantidade: { color: '#E0E0FF', fontSize: 15, fontFamily: 'Roboto-Bold',marginRight: 8, minWidth: 30, },
    itemDescricao: { flex: 1, color: '#E0E0E0', fontSize: 15, fontFamily: 'Roboto-Regular', },
    itemPreco: { color: '#E0E0E0', fontSize: 15, fontFamily: 'Roboto-Bold', marginLeft: 8, },
    ...
    valorLabel: { fontSize: 14, fontFamily: 'Roboto-Bold', color: '#E0E0FF', width: '40%', lineHeight: 22 },
    ...
    labelTotalFinal: { fontFamily: 'Roboto-Bold', fontSize: 16, },
    textoTotalFinal: { fontFamily: 'Roboto-Bold', fontSize: 16, },
    ...
    emptyListText: { textAlign: 'center', fontSize: 18, fontFamily: 'Roboto-Bold', color: 'rgba(255,255,255,0.7)', marginTop: 15 },
    itemData: { fontSize: 14, fontFamily: 'Roboto-Regular', color: '#E0E0FF', },
});