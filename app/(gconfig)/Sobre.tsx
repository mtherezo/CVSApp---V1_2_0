...
import { View, StyleSheet, ImageBackground, SafeAreaView, StatusBar, Platform, ScrollView, TouchableOpacity } from 'react-native';
...
const styles = StyleSheet.create({
    ...
    appName: { fontSize: 34, fontFamily: 'Roboto-Bold', color: "#FFFFFF", marginTop: 10 },
    versionText: { color: 'rgba(255, 255, 255, 0.6)', fontSize: 16, fontFamily: 'Roboto-Regular', marginBottom: 25 },
    descriptionText: {
        fontSize: 16,
        color: '#E0E0FF',
        textAlign: 'center',
